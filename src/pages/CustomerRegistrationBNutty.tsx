...
const CustomerRegistrationBNutty: React.FC = () => {
  ...
  const allergensList = ['Eggs', 'Milk', 'Soy', 'Sesame', 'Seafood', 'Halal', 'Kosher', 'Tree Nuts', 'Coconut', 'Almonds', 'Pecans', 'Cashews', 'Walnuts', 'Mango', 'Hazelnut', 'Brazil Nut']
    ...
    try {
      ...
      if (!ensuredOnboardingId) {
        const { data: onboardingData, error: onboardingError } = await supabase
          ...
          .insert({ customer_id: ensuredCustomerId, onboarding_type: 'BNUTTY', status: 'Submitted', notes: onboardingNotes || null })
          .select('id')
          .single()
      ...
      if (selectedAllergens.length > 0) {
        const allergenRecords = selectedAllergens.map(allergen => ({ onboarding_id: ensuredOnboardingId, allergen, is_present: true }))
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-light/20 via-white to-primary-medium/20 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl border border-neutral-soft/30 overflow-hidden">
          <div className="bg-gradient-to-r from-accent-success to-primary-medium p-8 text-center">
            ...
            <p className="text-white/90 text-lg">Thank you for registering with BNutty</p>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-neutral-soft/30 overflow-hidden">
          <div className="bg-gradient-to-r from-primary-dark via-primary-medium to-primary-light p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">BNutty Customer Registration</h1>
          ...
          <div className="p-8 space-y-8">
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      id="bnutty_company_name"
                      name="bnutty_company_name"
                      type="text"
                      required
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      id="bnutty_contact_person"
                      name="bnutty_contact_person"
                      type="text"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-soft/20 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <input id="bnutty_new_packaging_type" name="bnutty_new_packaging_type" type="text" value={newPackaging.packaging_type} onChange={(e) => setNewPackaging({ ...newPackaging, packaging_type: e.target.value })} placeholder="Packaging Type" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  <input id="bnutty_new_packaging_size" name="bnutty_new_packaging_size" type="text" value={newPackaging.size} onChange={(e) => setNewPackaging({ ...newPackaging, size: e.target.value })} placeholder="Size" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  <input id="bnutty_new_packaging_qty" name="bnutty_new_packaging_qty" type="number" value={newPackaging.case_pack_qty} onChange={(e) => setNewPackaging({ ...newPackaging, case_pack_qty: e.target.value })} placeholder="Case Pack Qty" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-soft/20 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input id="bnutty_new_ingredient_name" name="bnutty_new_ingredient_name" type="text" value={newIngredient.ingredient_name} onChange={(e) => setNewIngredient({ ...newIngredient, ingredient_name: e.target.value })} placeholder="Ingredient Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  <input id="bnutty_new_ingredient_vendor" name="bnutty_new_ingredient_vendor" type="text" value={newIngredient.vendor_name} onChange={(e) => setNewIngredient({ ...newIngredient, vendor_name: e.target.value })} placeholder="Vendor Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                </div>
                <label className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {allergensList.map((allergen) => (
                    <label key={allergen} className="flex items-center gap-2">
                      <input type="checkbox" checked={selectedAllergens.includes(allergen)} onChange={(e) => { if (e.target.checked) { setSelectedAllergens([...selectedAllergens, allergen]) } else { setSelectedAllergens(selectedAllergens.filter(a => a !== allergen)) } }} className="h-4 w-4" />
...
export default CustomerRegistrationBNutty
