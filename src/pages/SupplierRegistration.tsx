              ...
              <div className="p-6 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" value={formData.account_rep_name} onChange={(e) => setFormData({ ...formData, account_rep_name: e.target.value })} placeholder="Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="email" value={formData.account_rep_email} onChange={(e) => setFormData({ ...formData, account_rep_email: e.target.value })} placeholder="Email" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.account_rep_office_phone} onChange={(e) => setFormData({ ...formData, account_rep_office_phone: e.target.value })} placeholder="Office Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.account_rep_cell_phone} onChange={(e) => setFormData({ ...formData, account_rep_cell_phone: e.target.value })} placeholder="Cell Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" value={formData.ap_rep_name} onChange={(e) => setFormData({ ...formData, ap_rep_name: e.target.value })} placeholder="Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="email" value={formData.ap_rep_email} onChange={(e) => setFormData({ ...formData, ap_rep_email: e.target.value })} placeholder="Email" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.ap_rep_office_phone} onChange={(e) => setFormData({ ...formData, ap_rep_office_phone: e.target.value })} placeholder="Office Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.ap_rep_cell_phone} onChange={(e) => setFormData({ ...formData, ap_rep_cell_phone: e.target.value })} placeholder="Cell Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" value={formData.qa_rep_name} onChange={(e) => setFormData({ ...formData, qa_rep_name: e.target.value })} placeholder="Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="email" value={formData.qa_rep_email} onChange={(e) => setFormData({ ...formData, qa_rep_email: e.target.value })} placeholder="Email" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.qa_rep_office_phone} onChange={(e) => setFormData({ ...formData, qa_rep_office_phone: e.target.value })} placeholder="Office Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.qa_rep_cell_phone} onChange={(e) => setFormData({ ...formData, qa_rep_cell_phone: e.target.value })} placeholder="Cell Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" value={formData.emergency_contact_name} onChange={(e) => setFormData({ ...formData, emergency_contact_name: e.target.value })} placeholder="Name" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="email" value={formData.emergency_contact_email} onChange={(e) => setFormData({ ...formData, emergency_contact_email: e.target.value })} placeholder="Email" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.emergency_contact_office_phone} onChange={(e) => setFormData({ ...formData, emergency_contact_office_phone: e.target.value })} placeholder="Office Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                    <input type="text" value={formData.emergency_contact_cell_phone} onChange={(e) => setFormData({ ...formData, emergency_contact_cell_phone: e.target.value })} placeholder="Cell Phone" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  </div>
                </div>
              </div>
            </div>
