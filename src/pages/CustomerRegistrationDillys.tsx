              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      id="dillys_company_name"
                      name="dillys_company_name"
                      type="text"
                      required
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      id="dillys_contact_person"
                      name="dillys_contact_person"
                      type="text"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-soft/20 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <input id="dillys_new_packaging_type" name="dillys_new_packaging_type" type="text" value={newPackaging.packaging_type} onChange={(e) => setNewPackaging({ ...newPackaging, packaging_type: e.target.value })} placeholder="Packaging Type" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  <input id="dillys_new_packaging_size" name="dillys_new_packaging_size" type="text" value={newPackaging.size} onChange={(e) => setNewPackaging({ ...newPackaging, size: e.target.value })} placeholder="Size" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                  <input id="dillys_new_packaging_qty" name="dillys_new_packaging_qty" type="number" value={newPackaging.case_pack_qty} onChange={(e) => setNewPackaging({ ...newPackaging, case_pack_qty: e.target.value })} placeholder="Case Pack Qty" className="px-4 py-2 border border-neutral-soft rounded-lg focus:ring-2 focus:ring-primary-light focus:border-primary-light" />
                </div>
